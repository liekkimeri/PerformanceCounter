...
namespace PerformanceCounterWebApi.Controllers
{
    public class PerformancesController : ApiController
    {
        ...
        public IHttpActionResult PutPerformance(int id, Performance performance)
        {
            ...
            if (id != performance.Perfermance_ID)
            {
                return BadRequest();
            }
        ...
        public IHttpActionResult PostPerformance(Performance performance)
        {
            ...
            return CreatedAtRoute("DefaultApi", new { id = performance.Perfermance_ID }, performance);
        }
        ...
        {
            return db.Performances.Count(e => e.Perfermance_ID == id) > 0;
        }
    }
}